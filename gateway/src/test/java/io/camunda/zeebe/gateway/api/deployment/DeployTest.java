...
public final class DeployTest extends GatewayTest {

  @Test
  public void shouldMapRequestAndResponse() {
    // given
    final var stub = new DeployStub();
    stub.registerWith(brokerClient);

    final String bpmnName = "testProcess.bpmn";
    final String dmnName = "testDecision.dmn";

    final var builder = DeployRequest.newBuilder();
    ...
    assertThat(decision.getIsDuplicate()).isFalse();
    ...
    assertThat(drg.getNamespace()).isEqualTo(dmnName);
    assertThat(drg.getResourceName()).isEqualTo(dmnName);
    assertThat(drg.getIsDuplicate()).isFalse();
